...
def configure(self):
	...
	kernel.config("BLK_DEV", "y")

	kernel.config("BLK_DEV_RAM", "y")

	kernel.config("MD", "y")
	kernel.config("BLK_DEV_DM", "y")
	kernel.config("DM_CRYPT", "y")
	kernel.config("DM_SNAPSHOT", "y")
	kernel.config("DM_THIN_PROVISIONING", "y")
	kernel.config("DM_CACHE", "y")
	kernel.config("DM_MIRROR", "y")
	kernel.config("DM_ZERO", "y")
	kernel.config("DM_DELAY", "y")

	kernel.config("MAGIC_SYSRQ", "y")
